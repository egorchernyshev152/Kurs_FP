...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: Function(value $anonfun)
       tree position: line 146 of file:///C:/Users/toorr/v1/src/main/scala/MainApp.scala
            tree tpe: Unit => cats.effect.IO[cats.effect.ExitCode]
              symbol: value $anonfun
   symbol definition: val $anonfun: <notype> (a TermSymbol)
      symbol package: <empty>
       symbol owners: value $anonfun -> method run -> object MainApp
...
== Source file context for tree position ==
   ...
   144 
   145     for {
   146       _       <- IO.println("Загрузка данных...")
   147       eDb     <- loader.loadAll.value
   148       db      <- IO.fromEither(eDb.leftMap(new Exception(_)))
   149       profRef <- Ref.of[IO, List[Professor]](db.professors)
