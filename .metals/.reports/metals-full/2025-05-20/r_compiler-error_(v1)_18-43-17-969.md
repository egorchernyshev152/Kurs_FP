...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: TypeTree
       tree position: line 116 of file:///C:/Users/toorr/v1/src/main/scala/MainApp.scala
            tree tpe: <error>
              symbol: <none>
...
== Source file context for tree position ==
   ...
   113       },
   114       format = c => List(c.name, c.rating.toString, c.topics.mkString(";"))
   115     )
   116     val topRepo = new CsvRepository[IO, Topic](
   117       _CURSOR_parse = { case List(n, tags) => Some(Topic(n, tags.split(";").toList)); case _ => None },
