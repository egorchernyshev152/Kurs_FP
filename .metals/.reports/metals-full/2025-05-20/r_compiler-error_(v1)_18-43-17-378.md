...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: TypeTree
       tree position: line 91 of file:///C:/Users/toorr/v1/src/main/scala/MainApp.scala
            tree tpe: <error>
              symbol: <none>
...
== Source file context for tree position ==
    ...
    88 
    89   def run(args: List[String]): IO[ExitCode] = {
    90     // Создаём CSV-репозитории для всех сущностей
    91     val profRepo = new CsvRepository[IO, Professor](
    92       _CURSOR_parse = {
    93         case List(n, areas, h, av) =>
    94           for {
