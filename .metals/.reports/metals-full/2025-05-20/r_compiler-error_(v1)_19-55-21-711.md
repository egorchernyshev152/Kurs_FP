...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: Ident(_CURSOR_parse)
       tree position: line 108 of file:///C:/Users/toorr/v1/src/main/scala/MainApp.scala
            tree tpe: <error>
...
== Source file context for tree position ==
   ...
   105   def run(args: List[String]): IO[ExitCode] = {
   106     // 1) Настройка CSV-репозиториев
   107     val profRepo: Repository[Professor] = new CsvRepository[IO, Professor](
   108       _CURSOR_parse = {
   109         case List(n, areas, h, av) =>
   110           for {
   111             hi  <- h.toIntOption
