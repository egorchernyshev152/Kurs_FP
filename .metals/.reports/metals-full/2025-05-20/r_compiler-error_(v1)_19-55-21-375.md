...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: Ident(_CURSOR_parse)
       tree position: line 132 of file:///C:/Users/toorr/v1/src/main/scala/MainApp.scala
            tree tpe: <error>
              symbol: value <error: <none>>
   symbol definition: val <error: <none>>: <error> (a TermSymbol)
      symbol package: <empty>
       symbol owners: value <error: <none>> -> value topRepo -> method run -> object MainApp
...
== Source file context for tree position ==
   ...
   129     )
   130 
   131     val topRepo: Repository[Topic] = new CsvRepository[IO, Topic](
   132       _CURSOR_parse = { case List(n, tags) => Some(Topic(n, tags.split(";").toList)); case _ => None },
   133       format = t => List(t.name, t.tags.mkString(";"))
   134     )
   135 
