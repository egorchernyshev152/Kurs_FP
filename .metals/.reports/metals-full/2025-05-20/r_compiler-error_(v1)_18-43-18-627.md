...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: TypeTree
       tree position: line 120 of file:///C:/Users/toorr/v1/src/main/scala/MainApp.scala
            tree tpe: <error>
              symbol: <none>
...
== Source file context for tree position ==
   ...
   117       parse = { case List(n, tags) => Some(Topic(n, tags.split(";").toList)); case _ => None },
   118       format = t => List(t.name, t.tags.mkString(";"))
   119     )
   120     val artRepo = new CsvRepository[IO, Article](
   121       _CURSOR_parse = {
   122         case List(tl, top, doi, y) =>
   123           for { yi <- y.toIntOption } yield Article(tl, top, if (doi.nonEmpty) Some(doi) else None, yi)
