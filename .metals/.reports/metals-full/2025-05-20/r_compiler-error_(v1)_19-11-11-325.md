...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: TypeTree
       tree position: line 87 of file:///C:/Users/toorr/v1/src/main/scala/MainApp.scala
            tree tpe: <error>
              symbol: <none>
...
== Source file context for tree position ==
    ...
    84   import InputHelper._
    85   def run(args: List[String]): IO[ExitCode] = {
    86     // CSV-репозитории: один тип-параметр
    87     val profRepo = new CsvRepository[Professor](
    88       parse = {
    89         case List(n, areas, h, av) =>
    90           for {
