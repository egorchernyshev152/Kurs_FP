...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: Function(value $anonfun)
       tree position: line 124 of file:///C:/Users/toorr/v1/src/main/scala/MainApp.scala
            tree tpe: Unit => Unit
              symbol: value $anonfun
   symbol definition: val $anonfun: <notype> (a TermSymbol)
      symbol package: <empty>
       symbol owners: value $anonfun -> value $anonfun -> value $anonfun -> value $anonfun -> value $anonfun -> method appLoop -> method run -> object MainApp
...
== Source file context for tree position ==
   ...
   124       _CURSOR__    <- if(cont) appLoop(db, profRef) else IO.unit
   125     } yield ()
   126 
   127     for {
