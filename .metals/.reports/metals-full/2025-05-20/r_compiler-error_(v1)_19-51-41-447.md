...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: Ident(Topic)
       tree position: line 86 of file:///C:/Users/toorr/v1/src/main/scala/MainApp.scala
              symbol: <none>
...
== Source file context for tree position ==
    ...
    83       parse = { case List(n,r,t) => r.toDoubleOption.map(rd => Conference(n, rd, t.split(";").toList)); case _ => None },
    84       format= c => List(c.name, c.rating.toString, c.topics.mkString(";"))
    85     )
    86     val topRepo: Repository[Topic] = new CsvRepository[Topic](
    87       _CURSOR_parse = { case List(n,t) => Some(Topic(n, t.split(";").toList)); case _ => None },
