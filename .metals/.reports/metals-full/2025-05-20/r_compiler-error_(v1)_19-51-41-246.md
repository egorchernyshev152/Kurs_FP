...
### scala.reflect.internal.FatalError: 
  ...
  last tree to typer: Ident(Article)
       tree position: line 90 of file:///C:/Users/toorr/v1/src/main/scala/MainApp.scala
              symbol: <none>
...
== Source file context for tree position ==
    ...
    87       parse = { case List(n,t) => Some(Topic(n, t.split(";").toList)); case _ => None },
    88       format= t => List(t.name, t.tags.mkString(";"))
    89     )
    90     val artRepo: Repository[Article] = new CsvRepository[Article](
    91       _CURSOR_parse = { case List(t,tp,doi,y) => y.toIntOption.map(yi => Article(t, tp, if(doi.nonEmpty) Some(doi) else None, yi)); case _ => None },
    92       format= a => List(a.title, a.topic, a.doi.getOrElse(""), a.year.toString)
    93     )
